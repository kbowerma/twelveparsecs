...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-SFDCOfflinePoc/SalesforceSDKCore.framework"
  install_framework "Pods-SFDCOfflinePoc/SmartStore.framework"
  install_framework "Pods-SFDCOfflinePoc/SmartSync.framework"
  install_framework "Pods-SFDCOfflinePoc/WYPopoverController.framework"
fi
